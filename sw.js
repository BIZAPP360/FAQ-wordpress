...
const CACHE_NAME = 'mostaphasabri.com-1609839658551';
const SW_SUPPORTED_PROTOCOL_REGEX = /http(s?):/;
const pageUrls = JSON.parse('["/","/about","/services","/contact"]');
const staticAssets = JSON.parse('["https://img1.wsimg.com/poly/v2/polyfill.min.js?unknown=polyfill&flags=gated&features=default%2Cfetch%2CArray.prototype.%40%40iterator%2CArray.prototype.find%2CArray.prototype.findIndex%2CFunction.name%2CNumber.isFinite%2CPromise%2CString.prototype.repeat%2CMath.sign%2CMath.trunc%2CArray.prototype.includes%2CObject.entries%2CObject.values%2CObject.is%2CIntersectionObserver%2CIntl.~locale.en-US","//img1.wsimg.com/blobby/go/0fc5a12d-f3e4-46ee-89ae-4a4ce1cf5b4e/gpub/be06ebf7aa0886c4/script.js","//img1.wsimg.com/ceph-p3-01/website-builder-data-prod/static/widgets/UX.3.73.12.js","//fonts.googleapis.com/css?family=Archivo+Black:400&display=swap","//fonts.googleapis.com/css?family=Montserrat:400,700&display=swap"]');
const networkOnlyUrls = JSON.parse('["https://api.ola.godaddy.com","https://0fc5a12d-f3e4-46ee-89ae-4a4ce1cf5b4e.onlinestore.godaddy.com","https://img.secureserver.net/t/1/tl/event","https://img.test-secureserver.net/t/1/tl/event","https://www.google-analytics.com/collect","https://calendar.apps.dev-secureserver.net","https://calendar.apps.test-secureserver.net","https://calendar.apps.secureserver.net"]');
const networkOnlyUrlsRegex = JSON.parse('["mostaphasabri.com/m/api/.*","mostaphasabri.com(?:/.*)?/ola/services/.*","mostaphasabri.com/ola/meetings/.*","securepay.godaddy.com/api/apps/ola/accounts/.*"]').map(regexString => new RegExp(regexString));
const networkThenCacheUrls = JSON.parse('["https://blog.apps.secureserver.net/v1/website/0fc5a12d-f3e4-46ee-89ae-4a4ce1cf5b4e/feed/post/","https://blog.apps.secureserver.net/v1/website/0fc5a12d-f3e4-46ee-89ae-4a4ce1cf5b4e/feed"]');
const networkThenCacheUrlsRegex = JSON.parse('["mostaphasabri.com(?:/.*)?/f/.*"]').map(regexString => new RegExp(regexString));
